    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    GpxTrackId = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GpxPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GpxPoints_GpxTracks_GpxTrackId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharedTrips", x => new { x.UserId, x.TripId });
                    table.ForeignKey(
                        name: "FK_SharedTrips_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GpxTrackId = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Places_Wishlists_WishlistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWishlists", x => new { x.UserId, x.WishlistId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "INTEGER", nullable: false),
                    TripDayId = table.Column<string>(type: "TEXT", nullable: true),
                    TripId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GpxPoints_GpxTrackId",
                table: "GpxPoints",
                column: "GpxTrackId");

            migrationBuilder.CreateIndex(
                name: "IX_Places_WishlistId",
                table: "Places",
                column: "WishlistId");
